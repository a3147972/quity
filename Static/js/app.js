...
$(document).ready(function() {
	...
	$('#refresh').click(function(e) {
		...
		//console.log(ln);
		var tis = ln ? '娓呴櫎缂撳瓨' : 'Clear Local Storage';
...
function checkURL() {
	...
	if (url) {
		...
		document.title = 'ion虏 - ' + (title || document.title);
...
function drawBreadCrumb() {
	...
	nav_elems.each(function() {
		...
		if (!--count) document.title = 'ion虏 - ' + $.bread_crumb.find("li:last-child").text();
	});
...
//鏁板瓧杞牸寮�  e.g. 2000->2K  2000000->2M
